...
export const UsersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        patchUserMe: async (userPatchBody: UserPatchBody, xCustomLang?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const UsersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getUserMe(xCustomLang?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserEntity>> {
         ...
         * @throws {RequiredError}
         */
        async patchUserMe(userPatchBody: UserPatchBody, xCustomLang?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserEntity>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.patchUserMe(userPatchBody, xCustomLang, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const UsersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        patchUserMe(requestParameters: UsersApiPatchUserMeRequest, options?: AxiosRequestConfig): AxiosPromise<UserEntity> {
            return localVarFp.patchUserMe(requestParameters.userPatchBody, requestParameters.xCustomLang, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Send support request
         * @param {UsersApiPostSupportRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        postSupport(requestParameters: UsersApiPostSupportRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
...
/**
 * Request parameters for postSupport operation in UsersApi.
 * @export
 * @interface UsersApiPostSupportRequest
 */
export interface UsersApiPostSupportRequest {
    /**
     * 
     * @type {SupportRequestPostBody}
     * @memberof UsersApiPostSupport
     */
...
export class UsersApi extends BaseAPI {
    ...
    public patchUserMe(requestParameters: UsersApiPatchUserMeRequest, options?: AxiosRequestConfig) {
        return UsersApiFp(this.configuration).patchUserMe(requestParameters.userPatchBody, requestParameters.xCustomLang, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof UsersApi
     */
    public postSupport(requestParameters: UsersApiPostSupportRequest, options?: AxiosRequestConfig) {
        return UsersApiFp(this.configuration).postSupport(requestParameters.supportRequestPostBody, requestParameters.xCustomLang, options).then((request) => request(this.axios, this.basePath));
    }
}
