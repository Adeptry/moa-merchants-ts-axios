...
export const CatalogsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        patchVariation: async (id: string, variationPatchBody: VariationPatchBody, xCustomLang?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('patchVariation', 'id', id)
            // verify required parameter 'variationPatchBody' is not null or undefined
            assertParamExists('patchVariation', 'variationPatchBody', variationPatchBody)
...
export const CatalogsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async patchVariation(id: string, variationPatchBody: VariationPatchBody, xCustomLang?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VariationEntity>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.patchVariation(id, variationPatchBody, xCustomLang, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const CatalogsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * 
         * @summary Update an Variation
         * @param {CatalogsApiPatchVariationRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        patchVariation(requestParameters: CatalogsApiPatchVariationRequest, options?: AxiosRequestConfig): AxiosPromise<VariationEntity> {
            return localVarFp.patchVariation(requestParameters.id, requestParameters.variationPatchBody, requestParameters.xCustomLang, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Upload Square Catalog Image
...
/**
 * Request parameters for patchVariation operation in CatalogsApi.
 * @export
 * @interface CatalogsApiPatchVariationRequest
 */
export interface CatalogsApiPatchVariationRequest {
    /**
     * 
     * @type {string}
     * @memberof CatalogsApiPatchVariation
     */
    readonly id: string
...
export class CatalogsApi extends BaseAPI {
     ...
     * @memberof CatalogsApi
     */
    public patchVariation(requestParameters: CatalogsApiPatchVariationRequest, options?: AxiosRequestConfig) {
        return CatalogsApiFp(this.configuration).patchVariation(requestParameters.id, requestParameters.variationPatchBody, requestParameters.xCustomLang, options).then((request) => request(this.axios, this.basePath));
    }
