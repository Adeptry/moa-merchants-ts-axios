...
export interface OrdersApiGetOrdersRequest {
    ...
    /**
     * 
     * @type {'id' | 'squareId' | 'pickupDate' | 'closedDate' | 'customerId' | 'locationId' | 'totalMoneyAmount' | 'totalMoneyTaxAmount' | 'totalMoneyDiscountAmount' | 'totalMoneyTipAmount' | 'totalMoneyServiceChargeAmount' | 'appFeeMoneyAmount'}
     * @memberof OrdersApiGetOrders
     */
