...
export const OrdersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getOrders: async (page?: number, limit?: number, closed?: boolean, lineItems?: boolean, location?: boolean, orderField?: GetOrdersOrderFieldEnum, orderSort?: GetOrdersOrderSortEnum, actingAs?: GetOrdersActingAsEnum, merchantIdOrPath?: string, xCustomLang?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const OrdersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getOrders(page?: number, limit?: number, closed?: boolean, lineItems?: boolean, location?: boolean, orderField?: GetOrdersOrderFieldEnum, orderSort?: GetOrdersOrderSortEnum, actingAs?: GetOrdersActingAsEnum, merchantIdOrPath?: string, xCustomLang?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrdersPaginatedReponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getOrders(page, limit, closed, lineItems, location, orderField, orderSort, actingAs, merchantIdOrPath, xCustomLang, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const OrdersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        getOrders(requestParameters: OrdersApiGetOrdersRequest = {}, options?: AxiosRequestConfig): AxiosPromise<OrdersPaginatedReponse> {
            return localVarFp.getOrders(requestParameters.page, requestParameters.limit, requestParameters.closed, requestParameters.lineItems, requestParameters.location, requestParameters.orderField, requestParameters.orderSort, requestParameters.actingAs, requestParameters.merchantIdOrPath, requestParameters.xCustomLang, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Patch update Order, e.g. modify Location
...
export class OrdersApi extends BaseAPI {
    ...
    public getOrders(requestParameters: OrdersApiGetOrdersRequest = {}, options?: AxiosRequestConfig) {
        return OrdersApiFp(this.configuration).getOrders(requestParameters.page, requestParameters.limit, requestParameters.closed, requestParameters.lineItems, requestParameters.location, requestParameters.orderField, requestParameters.orderSort, requestParameters.actingAs, requestParameters.merchantIdOrPath, requestParameters.xCustomLang, options).then((request) => request(this.axios, this.basePath));
    }
