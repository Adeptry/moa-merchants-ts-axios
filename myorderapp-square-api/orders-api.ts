...
export interface OrdersApiGetOrdersRequest {
    ...
    /**
     * 
     * @type {'pickupDate' | 'closedDate' | 'customerId' | 'locationId' | 'totalMoneyAmount' | 'totalMoneyTaxAmount' | 'totalMoneyDiscountAmount' | 'totalMoneyTipAmount' | 'totalMoneyServiceChargeAmount' | 'appFeeMoneyAmount'}
     * @memberof OrdersApiGetOrders
     */
