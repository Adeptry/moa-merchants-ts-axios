...
export const CustomersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        deleteCustomerId: async (id: string, xCustomLang?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('deleteCustomerId', 'id', id)
            const localVarPath = `/v2/customers/{id}`
         ...
         * @throws {RequiredError}
         */
        deleteCustomerMe: async (merchantIdOrPath: string, xCustomLang?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'merchantIdOrPath' is not null or undefined
            assertParamExists('deleteCustomerMe', 'merchantIdOrPath', merchantIdOrPath)
         ...
         * @throws {RequiredError}
         */
        getCustomers: async (page?: number, limit?: number, user?: boolean, merchant?: boolean, currentOrder?: boolean, preferredLocation?: boolean, orderField?: GetCustomersOrderFieldEnum, orderSort?: GetCustomersOrderSortEnum, startDate?: string, endDate?: string, xCustomLang?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const CustomersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async deleteCustomerId(id: string, xCustomLang?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteCustomerId(id, xCustomLang, options);
         ...
         * @throws {RequiredError}
         */
        async deleteCustomerMe(merchantIdOrPath: string, xCustomLang?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CustomerEntity>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteCustomerMe(merchantIdOrPath, xCustomLang, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async getCustomers(page?: number, limit?: number, user?: boolean, merchant?: boolean, currentOrder?: boolean, preferredLocation?: boolean, orderField?: GetCustomersOrderFieldEnum, orderSort?: GetCustomersOrderSortEnum, startDate?: string, endDate?: string, xCustomLang?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CustomersPaginatedResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getCustomers(page, limit, user, merchant, currentOrder, preferredLocation, orderField, orderSort, startDate, endDate, xCustomLang, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const CustomersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * 
         * @summary Delete Customer with ID
         * @param {CustomersApiDeleteCustomerIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        deleteCustomerId(requestParameters: CustomersApiDeleteCustomerIdRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.deleteCustomerId(requestParameters.id, requestParameters.xCustomLang, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Delete current Customer
         * @param {CustomersApiDeleteCustomerMeRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        deleteCustomerMe(requestParameters: CustomersApiDeleteCustomerMeRequest, options?: AxiosRequestConfig): AxiosPromise<CustomerEntity> {
            return localVarFp.deleteCustomerMe(requestParameters.merchantIdOrPath, requestParameters.xCustomLang, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get current Customer
        ...
        getCustomers(requestParameters: CustomersApiGetCustomersRequest = {}, options?: AxiosRequestConfig): AxiosPromise<CustomersPaginatedResponse> {
            return localVarFp.getCustomers(requestParameters.page, requestParameters.limit, requestParameters.user, requestParameters.merchant, requestParameters.currentOrder, requestParameters.preferredLocation, requestParameters.orderField, requestParameters.orderSort, requestParameters.startDate, requestParameters.endDate, requestParameters.xCustomLang, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Update your Customer
...
/**
 * Request parameters for deleteCustomerId operation in CustomersApi.
 * @export
 * @interface CustomersApiDeleteCustomerIdRequest
 */
export interface CustomersApiDeleteCustomerIdRequest {
    /**
     * 
     * @type {string}
     * @memberof CustomersApiDeleteCustomerId
     */
    readonly id: string
...
/**
 * Request parameters for deleteCustomerMe operation in CustomersApi.
 * @export
 * @interface CustomersApiDeleteCustomerMeRequest
 */
export interface CustomersApiDeleteCustomerMeRequest {
    /**
     * 
     * @type {string}
     * @memberof CustomersApiDeleteCustomerMe
     */
...
export class CustomersApi extends BaseAPI {
     ...
     */
    public deleteCustomerId(requestParameters: CustomersApiDeleteCustomerIdRequest, options?: AxiosRequestConfig) {
        return CustomersApiFp(this.configuration).deleteCustomerId(requestParameters.id, requestParameters.xCustomLang, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CustomersApi
     */
    public deleteCustomerMe(requestParameters: CustomersApiDeleteCustomerMeRequest, options?: AxiosRequestConfig) {
        return CustomersApiFp(this.configuration).deleteCustomerMe(requestParameters.merchantIdOrPath, requestParameters.xCustomLang, options).then((request) => request(this.axios, this.basePath));
    }
