...
export const MerchantsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        confirmStripeCheckout(requestParameters: MerchantsApiConfirmStripeCheckoutRequest, options?: AxiosRequestConfig): AxiosPromise<Merchant> {
            return localVarFp.confirmStripeCheckout(requestParameters.stripeCheckoutDto, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Create Merchant for current User
