...
export const MerchantsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        postSquareOauthMe: async (squareConfirmOauthDto: SquareConfirmOauthDto, xCustomLang?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'squareConfirmOauthDto' is not null or undefined
            assertParamExists('postSquareOauthMe', 'squareConfirmOauthDto', squareConfirmOauthDto)
         ...
         * @throws {RequiredError}
         */
        postStripeCheckoutMe: async (stripeCheckoutCreateDto: StripeCheckoutCreateDto, xCustomLang?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'stripeCheckoutCreateDto' is not null or undefined
            assertParamExists('postStripeCheckoutMe', 'stripeCheckoutCreateDto', stripeCheckoutCreateDto)
...
export const MerchantsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getMerchantMe(user?: boolean, appConfig?: boolean, locations?: boolean, catalog?: boolean, xCustomLang?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Merchant>> {
         ...
         * @throws {RequiredError}
         */
        async getStripeBillingSessionMe(returnUrl: string, xCustomLang?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<StripeBillingPortalCreateOutput>> {
         ...
         * @throws {RequiredError}
         */
        async postMerchantMe(xCustomLang?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Merchant>> {
         ...
         * @throws {RequiredError}
         */
        async postSquareOauthMe(squareConfirmOauthDto: SquareConfirmOauthDto, xCustomLang?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.postSquareOauthMe(squareConfirmOauthDto, xCustomLang, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async postStripeCheckoutMe(stripeCheckoutCreateDto: StripeCheckoutCreateDto, xCustomLang?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<StripeCheckoutDto>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.postStripeCheckoutMe(stripeCheckoutCreateDto, xCustomLang, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const MerchantsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getMerchantMe(requestParameters: MerchantsApiGetMerchantMeRequest = {}, options?: AxiosRequestConfig): AxiosPromise<Merchant> {
         ...
         * @throws {RequiredError}
         */
        getStripeBillingSessionMe(requestParameters: MerchantsApiGetStripeBillingSessionMeRequest, options?: AxiosRequestConfig): AxiosPromise<StripeBillingPortalCreateOutput> {
         ...
         * @throws {RequiredError}
         */
        postMerchantMe(requestParameters: MerchantsApiPostMerchantMeRequest = {}, options?: AxiosRequestConfig): AxiosPromise<Merchant> {
        ...
        postSquareOauthMe(requestParameters: MerchantsApiPostSquareOauthMeRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.postSquareOauthMe(requestParameters.squareConfirmOauthDto, requestParameters.xCustomLang, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Start Stripe checkout
         ...
         * @throws {RequiredError}
         */
        postStripeCheckoutMe(requestParameters: MerchantsApiPostStripeCheckoutMeRequest, options?: AxiosRequestConfig): AxiosPromise<StripeCheckoutDto> {
            return localVarFp.postStripeCheckoutMe(requestParameters.stripeCheckoutCreateDto, requestParameters.xCustomLang, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class MerchantsApi extends BaseAPI {
    ...
    public postSquareOauthMe(requestParameters: MerchantsApiPostSquareOauthMeRequest, options?: AxiosRequestConfig) {
        return MerchantsApiFp(this.configuration).postSquareOauthMe(requestParameters.squareConfirmOauthDto, requestParameters.xCustomLang, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public postStripeCheckoutMe(requestParameters: MerchantsApiPostStripeCheckoutMeRequest, options?: AxiosRequestConfig) {
        return MerchantsApiFp(this.configuration).postStripeCheckoutMe(requestParameters.stripeCheckoutCreateDto, requestParameters.xCustomLang, options).then((request) => request(this.axios, this.basePath));
    }
}
