...
export const MerchantsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getCurrentMerchant: async (user?: boolean, appConfig?: boolean, locations?: boolean, iosZipFile?: boolean, androidZipFile?: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        squareSync: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const MerchantsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getCurrentMerchant(user?: boolean, appConfig?: boolean, locations?: boolean, iosZipFile?: boolean, androidZipFile?: boolean, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Merchant>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getCurrentMerchant(user, appConfig, locations, iosZipFile, androidZipFile, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async squareSync(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.squareSync(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const MerchantsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        getCurrentMerchant(requestParameters: MerchantsApiGetCurrentMerchantRequest = {}, options?: AxiosRequestConfig): AxiosPromise<Merchant> {
            return localVarFp.getCurrentMerchant(requestParameters.user, requestParameters.appConfig, requestParameters.locations, requestParameters.iosZipFile, requestParameters.androidZipFile, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Sync your Square Catalog
         ...
         * @throws {RequiredError}
         */
        squareSync(options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.squareSync(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class MerchantsApi extends BaseAPI {
    ...
    public getCurrentMerchant(requestParameters: MerchantsApiGetCurrentMerchantRequest = {}, options?: AxiosRequestConfig) {
        return MerchantsApiFp(this.configuration).getCurrentMerchant(requestParameters.user, requestParameters.appConfig, requestParameters.locations, requestParameters.iosZipFile, requestParameters.androidZipFile, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof MerchantsApi
     */
    public squareSync(options?: AxiosRequestConfig) {
        return MerchantsApiFp(this.configuration).squareSync(options).then((request) => request(this.axios, this.basePath));
    }
}
