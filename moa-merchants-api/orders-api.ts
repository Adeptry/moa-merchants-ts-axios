...
export const OrdersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getOrders: async (page?: number, limit?: number, closed?: boolean, lineItems?: boolean, location?: boolean, actingAs?: GetOrdersActingAsEnum, merchantIdOrPath?: string, xCustomLang?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        patchOrderCurrent: async (orderPatchDto: OrderPatchDto, lineItems?: boolean, location?: boolean, idempotencyKey?: string, merchantIdOrPath?: string, xCustomLang?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'orderPatchDto' is not null or undefined
            assertParamExists('patchOrderCurrent', 'orderPatchDto', orderPatchDto)
            const localVarPath = `/v2/orders/current`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        postOrder: async (merchantIdOrPath: string, orderCreateDto: OrderCreateDto, lineItems?: boolean, location?: boolean, xCustomLang?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'merchantIdOrPath' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        postOrderCurrent: async (merchantIdOrPath: string, orderPostDto: OrderPostDto, lineItems?: boolean, location?: boolean, idempotencyKey?: string, xCustomLang?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'merchantIdOrPath' is not null or undefined
            ...
            assertParamExists('postOrderCurrent', 'orderPostDto', orderPostDto)
            const localVarPath = `/v2/orders/current`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        postSquarePaymentOrderCurrent: async (merchantIdOrPath: string, paymentCreateDto: PaymentCreateDto, lineItems?: boolean, location?: boolean, xCustomLang?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'merchantIdOrPath' is not null or undefined
            ...
            assertParamExists('postSquarePaymentOrderCurrent', 'paymentCreateDto', paymentCreateDto)
...
export const OrdersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async deleteLineItemCurrent(id: string, merchantIdOrPath: string, lineItems?: boolean, location?: boolean, xCustomLang?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Order>> {
         ...
         * @throws {RequiredError}
         */
        async getOrder(id: string, lineItems?: boolean, location?: boolean, actingAs?: GetOrderActingAsEnum, merchantIdOrPath?: string, xCustomLang?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Order>> {
         ...
         * @throws {RequiredError}
         */
        async getOrderCurrent(merchantIdOrPath: string, lineItems?: boolean, location?: boolean, xCustomLang?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Order>> {
         ...
         * @throws {RequiredError}
         */
        async getOrders(page?: number, limit?: number, closed?: boolean, lineItems?: boolean, location?: boolean, actingAs?: GetOrdersActingAsEnum, merchantIdOrPath?: string, xCustomLang?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrdersPaginatedReponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getOrders(page, limit, closed, lineItems, location, actingAs, merchantIdOrPath, xCustomLang, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async patchOrderCurrent(orderPatchDto: OrderPatchDto, lineItems?: boolean, location?: boolean, idempotencyKey?: string, merchantIdOrPath?: string, xCustomLang?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Order>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.patchOrderCurrent(orderPatchDto, lineItems, location, idempotencyKey, merchantIdOrPath, xCustomLang, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async postOrder(merchantIdOrPath: string, orderCreateDto: OrderCreateDto, lineItems?: boolean, location?: boolean, xCustomLang?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Order>> {
         ...
         * @throws {RequiredError}
         */
        async postOrderCurrent(merchantIdOrPath: string, orderPostDto: OrderPostDto, lineItems?: boolean, location?: boolean, idempotencyKey?: string, xCustomLang?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Order>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.postOrderCurrent(merchantIdOrPath, orderPostDto, lineItems, location, idempotencyKey, xCustomLang, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async postSquarePaymentOrderCurrent(merchantIdOrPath: string, paymentCreateDto: PaymentCreateDto, lineItems?: boolean, location?: boolean, xCustomLang?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Order>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.postSquarePaymentOrderCurrent(merchantIdOrPath, paymentCreateDto, lineItems, location, xCustomLang, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const OrdersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        deleteLineItemCurrent(requestParameters: OrdersApiDeleteLineItemCurrentRequest, options?: AxiosRequestConfig): AxiosPromise<Order> {
         ...
         * @throws {RequiredError}
         */
        getOrderCurrent(requestParameters: OrdersApiGetOrderCurrentRequest, options?: AxiosRequestConfig): AxiosPromise<Order> {
        ...
        getOrders(requestParameters: OrdersApiGetOrdersRequest = {}, options?: AxiosRequestConfig): AxiosPromise<OrdersPaginatedReponse> {
            return localVarFp.getOrders(requestParameters.page, requestParameters.limit, requestParameters.closed, requestParameters.lineItems, requestParameters.location, requestParameters.actingAs, requestParameters.merchantIdOrPath, requestParameters.xCustomLang, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Patch update Order, e.g. modify Location
         ...
         * @throws {RequiredError}
         */
        patchOrderCurrent(requestParameters: OrdersApiPatchOrderCurrentRequest, options?: AxiosRequestConfig): AxiosPromise<Order> {
            return localVarFp.patchOrderCurrent(requestParameters.orderPatchDto, requestParameters.lineItems, requestParameters.location, requestParameters.idempotencyKey, requestParameters.merchantIdOrPath, requestParameters.xCustomLang, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Create Order
         ...
         * @throws {RequiredError}
         */
        postOrderCurrent(requestParameters: OrdersApiPostOrderCurrentRequest, options?: AxiosRequestConfig): AxiosPromise<Order> {
            return localVarFp.postOrderCurrent(requestParameters.merchantIdOrPath, requestParameters.orderPostDto, requestParameters.lineItems, requestParameters.location, requestParameters.idempotencyKey, requestParameters.xCustomLang, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Pay for Order
         ...
         * @throws {RequiredError}
         */
        postSquarePaymentOrderCurrent(requestParameters: OrdersApiPostSquarePaymentOrderCurrentRequest, options?: AxiosRequestConfig): AxiosPromise<Order> {
            return localVarFp.postSquarePaymentOrderCurrent(requestParameters.merchantIdOrPath, requestParameters.paymentCreateDto, requestParameters.lineItems, requestParameters.location, requestParameters.xCustomLang, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class OrdersApi extends BaseAPI {
    ...
    public patchOrderCurrent(requestParameters: OrdersApiPatchOrderCurrentRequest, options?: AxiosRequestConfig) {
        return OrdersApiFp(this.configuration).patchOrderCurrent(requestParameters.orderPatchDto, requestParameters.lineItems, requestParameters.location, requestParameters.idempotencyKey, requestParameters.merchantIdOrPath, requestParameters.xCustomLang, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public postOrderCurrent(requestParameters: OrdersApiPostOrderCurrentRequest, options?: AxiosRequestConfig) {
        return OrdersApiFp(this.configuration).postOrderCurrent(requestParameters.merchantIdOrPath, requestParameters.orderPostDto, requestParameters.lineItems, requestParameters.location, requestParameters.idempotencyKey, requestParameters.xCustomLang, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public postSquarePaymentOrderCurrent(requestParameters: OrdersApiPostSquarePaymentOrderCurrentRequest, options?: AxiosRequestConfig) {
        return OrdersApiFp(this.configuration).postSquarePaymentOrderCurrent(requestParameters.merchantIdOrPath, requestParameters.paymentCreateDto, requestParameters.lineItems, requestParameters.location, requestParameters.xCustomLang, options).then((request) => request(this.axios, this.basePath));
    }
}
