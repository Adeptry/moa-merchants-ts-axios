...
export const AppConfigsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        patchAppConfigMe: async (appConfigUpdateDto: AppConfigUpdateDto, xCustomLang?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'appConfigUpdateDto' is not null or undefined
            assertParamExists('patchAppConfigMe', 'appConfigUpdateDto', appConfigUpdateDto)
            const localVarPath = `/v2/app-config/me`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        postAppConfigMe: async (appConfigUpdateDto: AppConfigUpdateDto, xCustomLang?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'appConfigUpdateDto' is not null or undefined
            assertParamExists('postAppConfigMe', 'appConfigUpdateDto', appConfigUpdateDto)
            const localVarPath = `/v2/app-config/me`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const AppConfigsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAppConfig(merchantIdOrPath: string, xCustomLang?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AppConfig>> {
         ...
         * @throws {RequiredError}
         */
        async getAppConfigMe(merchantIdOrPath?: string, actingAs?: GetAppConfigMeActingAsEnum, xCustomLang?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AppConfig>> {
         ...
         * @throws {RequiredError}
         */
        async patchAppConfigMe(appConfigUpdateDto: AppConfigUpdateDto, xCustomLang?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AppConfig>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.patchAppConfigMe(appConfigUpdateDto, xCustomLang, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async postAppConfigMe(appConfigUpdateDto: AppConfigUpdateDto, xCustomLang?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AppConfig>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.postAppConfigMe(appConfigUpdateDto, xCustomLang, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const AppConfigsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAppConfigMe(requestParameters: AppConfigsApiGetAppConfigMeRequest = {}, options?: AxiosRequestConfig): AxiosPromise<AppConfig> {
         ...
         * @throws {RequiredError}
         */
        patchAppConfigMe(requestParameters: AppConfigsApiPatchAppConfigMeRequest, options?: AxiosRequestConfig): AxiosPromise<AppConfig> {
            return localVarFp.patchAppConfigMe(requestParameters.appConfigUpdateDto, requestParameters.xCustomLang, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Create your Config
         ...
         * @throws {RequiredError}
         */
        postAppConfigMe(requestParameters: AppConfigsApiPostAppConfigMeRequest, options?: AxiosRequestConfig): AxiosPromise<AppConfig> {
            return localVarFp.postAppConfigMe(requestParameters.appConfigUpdateDto, requestParameters.xCustomLang, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Upload icon
...
export class AppConfigsApi extends BaseAPI {
    ...
    public patchAppConfigMe(requestParameters: AppConfigsApiPatchAppConfigMeRequest, options?: AxiosRequestConfig) {
        return AppConfigsApiFp(this.configuration).patchAppConfigMe(requestParameters.appConfigUpdateDto, requestParameters.xCustomLang, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public postAppConfigMe(requestParameters: AppConfigsApiPostAppConfigMeRequest, options?: AxiosRequestConfig) {
        return AppConfigsApiFp(this.configuration).postAppConfigMe(requestParameters.appConfigUpdateDto, requestParameters.xCustomLang, options).then((request) => request(this.axios, this.basePath));
    }
