...
export const CustomersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getCurrentCustomer: async (merchantId: string, user?: boolean, merchant?: boolean, currentOrder?: boolean, preferredLocation?: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'merchantId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        updateMyCustomer: async (merchantId: string, customerUpdateDto: CustomerUpdateDto, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'merchantId' is not null or undefined
            assertParamExists('updateMyCustomer', 'merchantId', merchantId)
            // verify required parameter 'customerUpdateDto' is not null or undefined
            assertParamExists('updateMyCustomer', 'customerUpdateDto', customerUpdateDto)
            const localVarPath = `/v2/customers/me`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const CustomersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getCurrentCustomer(merchantId: string, user?: boolean, merchant?: boolean, currentOrder?: boolean, preferredLocation?: boolean, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Customer>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getCurrentCustomer(merchantId, user, merchant, currentOrder, preferredLocation, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async updateMyCustomer(merchantId: string, customerUpdateDto: CustomerUpdateDto, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Customer>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateMyCustomer(merchantId, customerUpdateDto, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const CustomersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        getCurrentCustomer(requestParameters: CustomersApiGetCurrentCustomerRequest, options?: AxiosRequestConfig): AxiosPromise<Customer> {
            return localVarFp.getCurrentCustomer(requestParameters.merchantId, requestParameters.user, requestParameters.merchant, requestParameters.currentOrder, requestParameters.preferredLocation, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get my Customers
         ...
         * 
         * @summary Update your Customer
         * @param {CustomersApiUpdateMyCustomerRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateMyCustomer(requestParameters: CustomersApiUpdateMyCustomerRequest, options?: AxiosRequestConfig): AxiosPromise<Customer> {
            return localVarFp.updateMyCustomer(requestParameters.merchantId, requestParameters.customerUpdateDto, options).then((request) => request(axios, basePath));
        },
    };
};
...
/**
 * Request parameters for updateMyCustomer operation in CustomersApi.
 * @export
 * @interface CustomersApiUpdateMyCustomerRequest
 */
export interface CustomersApiUpdateMyCustomerRequest {
    /**
     * 
     * @type {string}
     * @memberof CustomersApiUpdateMyCustomer
     */
    readonly merchantId: string
...
export class CustomersApi extends BaseAPI {
    ...
    public getCurrentCustomer(requestParameters: CustomersApiGetCurrentCustomerRequest, options?: AxiosRequestConfig) {
        return CustomersApiFp(this.configuration).getCurrentCustomer(requestParameters.merchantId, requestParameters.user, requestParameters.merchant, requestParameters.currentOrder, requestParameters.preferredLocation, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CustomersApi
     */
    public updateMyCustomer(requestParameters: CustomersApiUpdateMyCustomerRequest, options?: AxiosRequestConfig) {
        return CustomersApiFp(this.configuration).updateMyCustomer(requestParameters.merchantId, requestParameters.customerUpdateDto, options).then((request) => request(this.axios, this.basePath));
    }
}
