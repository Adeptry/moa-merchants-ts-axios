...
export const CatalogsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getCatalog: async (merchantId: string, actingAs: GetCatalogActingAsEnum, page?: number, limit?: number, locationId?: string, items?: boolean, variations?: boolean, modifierLists?: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getItemsInCategory: async (id: string, page?: number, limit?: number, locationId?: string, images?: boolean, variations?: boolean, modifierLists?: boolean, actingAs?: GetItemsInCategoryActingAsEnum, merchantId?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getMyCatalog: async (page?: number, limit?: number, locationId?: string, items?: boolean, variations?: boolean, modifierLists?: boolean, actingAs?: GetMyCatalogActingAsEnum, merchantId?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const CatalogsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getCatalog(merchantId: string, actingAs: GetCatalogActingAsEnum, page?: number, limit?: number, locationId?: string, items?: boolean, variations?: boolean, modifierLists?: boolean, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CategoryPaginatedResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getCatalog(merchantId, actingAs, page, limit, locationId, items, variations, modifierLists, options);
         ...
         * @throws {RequiredError}
         */
        async getItemsInCategory(id: string, page?: number, limit?: number, locationId?: string, images?: boolean, variations?: boolean, modifierLists?: boolean, actingAs?: GetItemsInCategoryActingAsEnum, merchantId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ItemPaginatedResponse>> {
         ...
         * @throws {RequiredError}
         */
        async getMyCatalog(page?: number, limit?: number, locationId?: string, items?: boolean, variations?: boolean, modifierLists?: boolean, actingAs?: GetMyCatalogActingAsEnum, merchantId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CategoryPaginatedResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getMyCatalog(page, limit, locationId, items, variations, modifierLists, actingAs, merchantId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const CatalogsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        getCatalog(requestParameters: CatalogsApiGetCatalogRequest, options?: AxiosRequestConfig): AxiosPromise<CategoryPaginatedResponse> {
            return localVarFp.getCatalog(requestParameters.merchantId, requestParameters.actingAs, requestParameters.page, requestParameters.limit, requestParameters.locationId, requestParameters.items, requestParameters.variations, requestParameters.modifierLists, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get Item with ID
        ...
        getMyCatalog(requestParameters: CatalogsApiGetMyCatalogRequest = {}, options?: AxiosRequestConfig): AxiosPromise<CategoryPaginatedResponse> {
            return localVarFp.getMyCatalog(requestParameters.page, requestParameters.limit, requestParameters.locationId, requestParameters.items, requestParameters.variations, requestParameters.modifierLists, requestParameters.actingAs, requestParameters.merchantId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get Item variations with ID
